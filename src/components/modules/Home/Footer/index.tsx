...
export default function Footer() {
  return (
    <section className="snap-start w-full min-h-[300px] bg-gray-100 py-12">
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-gray-600">
            Discover and experience art from around the world in a new way.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="text-sm text-gray-600 hover:text-primary">Exhibitions</a></li>
            <li><a href="#" className="text-sm text-gray-600 hover:text-primary">Galleries</a></li>
          </ul>
        </div>
      ...
      <div className="border-t border-gray-200 mt-12 pt-6">
        <p className="text-sm text-gray-500 text-center">© 2023 Artverse. All rights reserved.</p>
      </div>
    </div>
  </section>
  )
